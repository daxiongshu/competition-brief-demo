...
![How a real edit is told apart from an identical rerun](plots/diff_method.png)
...
![Per-version public LB for the six fully-diffed kernels](plots/version_trajectories.png)
...
![Identical-code groups and the LB spread they produce](plots/rerun_noise.png)
...
![Lines of code touched vs change in public LB](plots/change_vs_delta.png)
...
![Featured-kernel dependency web](plots/dependency_web.png)
